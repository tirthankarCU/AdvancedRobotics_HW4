...
if __name__ == '__main__':
    param_init=np.array([0.5,1,0.1,0.1])
    res=minimize(fun=main(),
                 x0=param_init,
                 method='BFGS',
                 options={'xtol': 1e-6, 'disp': False, 'verbose': 2}
                 )
    print(f'Optimal Controller Coeff {res.x}')